...
      <section
        ref={ref}
        className={` border border-gray-800 p-6 rounded-2xl shadow-2xl transition-all duration-1000 transform ease-out ${
...
  // Reusable button component for "More Info"
  const MoreInfoButton = ({ title }) => (
    <div className="mt-6 pt-4 border-t border-gray-800">
      <button
        onClick={() => alert(`Showing more information for: ${title}`)}
        className="w-full text-center py-2 px-4 bg-gray-700 text-[#56f6a6] rounded-lg font-semibold hover:bg-gray-600 transition duration-200 shadow-md"
      >
        More Info
      </button>
    </div>
...
    <main className="min-h-screen  text-gray-100 py-16 px-4 md:px-12 lg:px-24 font-sans relative overflow-hidden">
...
          </ul>
          <MoreInfoButton title="Planning & Preparation" />
        </AnimatedSection>
...
            </div>
          </div>
          <MoreInfoButton title="Technical Implementation" />
        </AnimatedSection>
...
          </ul>
          <MoreInfoButton title="Quality Assurance & Testing" />
        </AnimatedSection>
...
          </ul>
          <MoreInfoButton title="Collaboration & Communication" />
        </AnimatedSection>
        
...
          </ul>
          <MoreInfoButton title="Data-Driven Optimization" />
        </AnimatedSection>
...
          </ul>
          <MoreInfoButton title="Reporting & Insights" />
        </AnimatedSection>

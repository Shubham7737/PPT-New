...
const TrafficCard = ({ item, index }) => {
  ...
  return (
    ...
    >
        ...
        <button className="w-full mt-2 text-center py-2 px-4 bg-emerald-700 text-white rounded-lg font-semibold hover:bg-gray-600 transition duration-200 shadow-md" >
                More Info</button>
    </div>
  );
};

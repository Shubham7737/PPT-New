    ...
    <div className="min-h-screen py-16 px-4 md:px-8 space-y-20 font-sans text-gray-200">
      ...
      <div className="bg-gray-800/50 max-w-5xl mx-auto rounded-3xl p-8 md:p-12 shadow-2xl shadow-sky-900/50 text-center border border-sky-900">
        ...
        <h2 className="mt-4 text-xl text-white md:text-2xl font-medium leading-relaxed max-w-3xl mx-auto animate-fadeInUp">
          {" "}
          {/* 💥 CHANGED: text-gray-600 to text-white 💥 */}
          We deliver custom website solutions that are conversion-focused,
          SEO-friendly, and built for high-speed performance on every device.
        </h2>
        <button
          onClick={openModal}
      ...
      <section className="max-w-6xl mx-auto space-y-16">
        ...
        {servicesContent.map((service, i) => (
          <div
            key={i}
            className={`bg-gray-800/50 flex flex-col items-center gap-8 p-6 md:p-10 rounded-3xl border border-sky-900 
          ...
          >
            ...
            {/* Content Card (md:w-1/2) */}
            <div className="md:w-1/2 space-y-4">
              <div className="flex items-center space-x-4">
                <div className="p-3 rounded-full bg-teal-900/50 shadow-md">
                  {service.icon}
                </div>
                <h3 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-sky-400">
                  {service.title}
                </h3>
              </div>

              {/* Content and Button Block - Made it a Flex Column to stack content */}
              <div className="flex flex-col">
                ...
                {/* More Info Button - ml-auto pushes the button to the right */}
                <button className="mt-4  ml-auto w-max px-6 py-2 text-sm font-semibold text-white bg-teal-600 rounded-lg hover:bg-teal-500 transition shadow-md">
                  More Info
                </button>
              </div>
            </div>
      ...
      {/* --- Highlight Cards (Technical Expertise) --- */}
      ...
      {/* --- Final CTA Card --- */}
      <div className="bg-gray-800/50 text-center mt-20 pb-10 max-w-4xl mx-auto p-8 rounded-3xl border border-sky-700 shadow-2xl shadow-sky-900/50">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
          Ready for a High-Performance Website?
        </h2>
        <p className="text-lg text-gray-300 mb-8">
          Start your digital transformation journey today. Let's build a
          powerful, custom web solution that drives real business results and
          maximizes your online reach.
        </p>
        <button
          onClick={openModal}
      ...
      {/* Custom Styles for animations (kept clean) */}
      <style>{`
                @keyframes fadeInUp {
